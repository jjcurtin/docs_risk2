...
screen <- tidy_qualtrics("screening", token_qualtrics,  display_progress = FALSE, raw=TRUE) 
```
...
Please text 'C' to CONFIRM this appointment. If you need to reschedule for any reason, please use the following link: https://doodle.com/bp/starstudy1/consent-session 
...
Please text 'C' to CONFIRM this appointment. If you need to reschedule for any reason, please let us know by replying to this email. 
