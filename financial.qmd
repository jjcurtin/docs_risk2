...
-   **Task completion bonuses.** Participants will be paid for task
    ...
    -   About \$33 per month for submitting daily updates (i.e.,
        answering all questions).

    -   Participants will earn \$0.75 per survey plus an additional \$5
        for completing at least 12 surveys in the first half of the
        month and an additional \$5 for completing at least 12 surveys
        in the second half of the month (total range of \$32.50 -
        \$33.25).

    -   About \$15 per month for daily video check ins(i.e., submitting
        a video). \$0.50 per video
...
-   NOTE: We cannot tell when participants disable SMS and phone logs OR
    SMS content \##### Compensation Plan (03/21 - 02/22)
