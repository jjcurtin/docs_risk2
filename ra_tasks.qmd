...
* [Consent/Onboard SOP](consent_onboarding_script.qmd)
 + [Consent/Onboard FAQ](faq_consent_onboarding.qmd)
 + [STAR FAQ](faq_arc_star_website.qmd)
* [One-week Visit SOP](one_week_check_in.qmd)
* If participants no-shows, [send them a message](no_show_texts.qmd) to remind them of the call and remind them they only have **3** chances to reschedule 



## Send reminders for tomorrow's visits
* Send [reminder messages](reminder_messages.qmd) 
...
* Check that phone numbers are not internet numbers
  + Go to [https://freecarrierlookup.com/](https://freecarrierlookup.com/)
...
* [Check compliance](compliance_check.qmd) via compliance script
  * Send [compliance messages](compliance_messages.qmd)
* Check compliance via [data_report_by_subid](check_data_by_subid.qmd)
...
* For returned W9 forms, [see SOP here](payment_w9_entry.qmd)
* For returned participant envelopes: 
  * Note returned envelopes in participant threads, prepare [replacement mailings](focus_blue_mailer_setup.qmd#sec-lost-card)


### Mail out new participant payment/onboard materials
* [See SOP here](focus_blue_mailer_setup.qmd)
 ...
 * Check [email box](study_email.qmd)
 * Check [Google Voice](google_voice.qmd) messages
 * Check STAR DMs
...
* Add issues to payment scratchpad/Web Log (WOG)
  * Practice WOG link: <https://uwmadison.co1.qualtrics.com/jfe/form/SV_9Naz0NHjR2bTYaO?practice=true> 
  * Real WOG link: <https://uwmadison.co1.qualtrics.com/jfe/form/SV_9Naz0NHjR2bTYaO>
 * Check STAR discussion boards
* Post the participant's question in their threads along with your planned response
* Add issues to payment scratchpad/[Web Log (WOG)](https://uwmadison.co1.qualtrics.com/jfe/form/SV_0j6VO02Bh7PJcG2)
...
## Recruitment
* [Zipcodes project](https://uw-arc.slack.com/archives/C03U025043G/p1663774396574259)
* Reddit posts
* Craigslist posts
