...
* Enter W9s on spreadsheet: P:\studydata\risk2\administration\financial\participant_payment_logs\tax_info\w9.xlsx (Password in LastPass)
* Add "W9 received" on the person's thread
* Enter the person's name and last 4 social on the spreadsheet listed above
* File the W9 in the appropriate year folder, alphabetical by last name
