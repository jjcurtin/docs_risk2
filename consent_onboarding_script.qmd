...
## Overview of Running Consent/Onboarding
...
::: {.callout-caution collapse="true"}
## If not ready to consent/need more time to think about it
...
**\[If the download does not start, you can send this link via text: <https://star.achess.wisc.edu/apps/android/latest.apk>\]**
...
*Do you have any other questions about the access STAR will have to your device?*
...
1. **In Google Calendar, mark the onboarding session as DONE**

2.  **In Google Calendar, add the One-Week Check-In at the appropriate time, labeled with the participant's subid**
...
5.  **In the STAR website, send the STAR Welcome Message to the
    ...
    b. Go to Peer Support > Direct Messages
...
6.  **In Google Voice, add the participant's phone number to Contacts, with their 4-digit subid as their contact name**:
    a. See instructions [here](google_voice.qmd)
...
You also need to attach the [payment infographic image](images\monthly_payment_detail_infographic.png). This should also be saved on your RA computers' desktop for easy access. 
    

8.  **Submit a Visit Date Log**

    a.  <https://uwmadison.co1.qualtrics.com/jfe/form/SV_2hPstJohCYbTmKi>
    
9. **Submit Session Guide (if you have not already done so)**
