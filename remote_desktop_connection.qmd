...
-   For some computers, only the administrator can change the remote desktop settings. If that's the case, login to the "admin" account with password: HanaJoye\* to change the setting.\
